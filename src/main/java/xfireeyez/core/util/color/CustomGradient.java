...
import xfireeyez.core.client.render.texture.TextureUtils;
import xfireeyez.core.util.math.MathHelper;
...
public class CustomGradient {
    ...
    public ColorRGBA getColour(double position) {
        return new ColorRGBA(getColourI(position));
    }
